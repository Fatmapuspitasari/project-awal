...
class _ShoesRepairScreenState extends State<ShoesRepairScreen> {
  ...
  Future<void> _confirmBooking(String id, String title, String description, int totalPrice, int quantity) async {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text('Total: Rp ${_formatCurrency(totalPrice)}',
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              Container(
                ...
                child: const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('🔧 Info Pembayaran & Servis:',
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                    SizedBox(height: 4),
                    Text('• Pembayaran 50% di muka, 50% setelah selesai',
                        style: TextStyle(fontSize: 11)),
                    Text('• Estimasi pengerjaan: 3-7 hari kerja',
                        style: TextStyle(fontSize: 11)),
                    Text('• Garansi layanan: 30 hari',
                        style: TextStyle(fontSize: 11)),
                    Text('• Konsultasi gratis sebelum pengerjaan',
                        style: TextStyle(fontSize: 11)),
                  ],
                ),
              ),
        ...
        actions: [
          ...
          TextButton(
            onPressed: isLoading ? null : () => _processBooking(id, title, description, totalPrice, quantity),
            child: isLoading 
                ? const SizedBox(
                    width: 20,
                    height: 20,
  ...
  Future<void> _processBooking(String id, String title, String description, int totalPrice, int quantity) async {
    setState(() {
      isLoading = true;
    });
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Gagal menyimpan pesanan: ${_supabaseService.getErrorMessage(e)}'),
      ...
      SnackBar(
        content: Column(
          ...
          children: [
            ...
            Text('Pembayaran: $selectedPaymentMethod', style: TextStyle(fontSize: 12)),
          ],
        ),
  ...
  void _showLoginRequiredDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text('Anda harus login terlebih dahulu untuk melakukan pemesanan.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Image section
            GestureDetector(
              onTap: () => _showImageDialog(context, service['imagePath'], service['title']),
              child: ClipRRect(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isBooked
                    ? null
                    : () => _confirmBooking(id, service['title'], service['description'], total, quantity),
                style: ElevatedButton.styleFrom(
                  backgroundColor: isBooked ? Colors.grey.shade300 : const Color(0xFF2C7EF8),
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) =>
              _buildServiceCard(repairServices[index]),
        ),
      ),
    );
  }
